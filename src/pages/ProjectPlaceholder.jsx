...
export default function ProjectPlaceholder({ slug }) {
  ...
  return <article className="page-enter placeholder-detail">
    <header className="detail-hero frame"><div className="detail-breadcrumb"><Link to="/projects">Projects</Link><span>/</span><span>{project.number}</span></div><p className="eyebrow">Project details pending</p><h1>{project.title}</h1><div className="detail-deck"><p>프로젝트 코드와 실제 정보를 확인한 뒤 내용을 작성할 예정입니다.</p><span>TBD</span></div></header>
